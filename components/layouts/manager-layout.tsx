...
// import { BarChart, Package, Store, LogOut, ShoppingBag, Users } from "lucide-react"
      ...
      <div className="flex flex-1">
        <aside className="w-64 bg-gray-100 border-r">
          <nav className="p-4 space-y-2">
            ...
            <Link href="/manager/products">
              <Button
                variant={pathname === "/manager/products" ? "default" : "ghost"}
                className="w-full justify-start"
              >
                <Package className="h-4 w-4 mr-2" />
                Products
            ...
            <Link href="/manager/pricing">
              <Button
                variant={pathname === "/manager/pricing" ? "default" : "ghost"}
                className="w-full justify-start"
              >
            ...
            <Link href="/manager/reports">
              <Button
                variant={pathname === "/manager/reports" ? "default" : "ghost"}
                className="w-full justify-start"
              >
                <BarChart className="h-4 w-4 mr-2" />
                Reports
            ...
            <Link href="/manager/settings">
              <Button
                variant={pathname === "/manager/settings" ? "default" : "ghost"}
                className="w-full justify-start"
              >
